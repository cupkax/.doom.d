...
**** Visuals
***** Initial Hooks
Autofill mode currently disabled
#+begin_src emacs-lisp :tangle no
...
(use-package! org-ol-tree
  ...
  (setq org-ol-tree-ui-window-header-format
        ...
        org-ol-tree-ui-window-max-width 0.2 
        org-ol-tree-ui-window-position 'left)
  (add-hook 'org-ol-tree-mode-hook #'+word-wrap-mode))
#+end_src
***** Font Display
****** Headings
#+begin_src emacs-lisp
...
**** Hunspell
#+begin_src emacs-lisp
(defconst my-hunspell-local-data-dir (expand-file-name "~/Library/Spelling")
  "Directory of Aspell dictionaries.")

(unless (file-exists-p my-hunspell-local-data-dir)
  (mkdir my-hunspell-local-data-dir t))

;;;###autoload
(defun my-hunspell-cmd-flags (&optional camel-case &rest extra-args)
  "Return the list of arguments Emacs should use to run hunspell.
...
(setq ispell-dictionary "english"
      ...
      ispell-personal-dictionary (expand-file-name ".ispell_personal" my-hunspell-local-data-dir )
      ispell-extra-args (my-hunspell-cmd-flags t))

;; Ignore URL spell check
;;;###autoload
